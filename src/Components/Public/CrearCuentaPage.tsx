import { Modal, Box, Typography, Button, TextField, IconButton, Divider, Link, Checkbox, FormControlLabel, Snackbar } from '@mui/material';
            ...
            <Box sx={{
                ...
                <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <TextField
                        ...
                        helperText={touched.password && password.length < 8 ? "La contraseña debe tener al menos 8 caracteres" : ""}
                    ...
                    <TextField
                        ...
                        helperText={touched.confirmPassword && password !== confirmPassword ? "Las contraseñas no coinciden" : ""}
