...
const columns: GridColDef[] = [
  ...
  { field: 'Turno', headerName: 'Turno', width: 120, editable: true },
  { field: 'Entrada', headerName: 'Entrada', width: 120, editable: true },
  { field: 'Salida', headerName: 'Salida', width: 120, editable: true },
  {
    field: 'Editar',
    headerName: 'Editar',
    width: 100,
